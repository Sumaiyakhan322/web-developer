    ...
    return (
       ...
       <div className="navbar p-4 sticky inset-0  z-10  flex flex-col gap-5 md:flex-row justify-between  bg-[#193e51] ">
        <div className=" flex flex-col-reverse md:flex-row lg:navbar-start">
          <div className="dropdown  ">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow  rounded-box w-52 font-bold text-base space-x-2  bg-[#478686] text-white ">
           {navLinks}
            </ul>
          </div>
       <Link to={'/'}> <span className="cursor-pointer text-4xl text-[#c3bd2e] flex"><FaConnectdevelop></FaConnectdevelop>WebBazaar</span></Link>  
        ...
        {user ? (
            ...
            <Link to="/login">
              <button className="btn text-[#146666] border   border-[#c3bd2e]   hover:bg-white hover:text-[#c3bd2e] font-bold">Login</button>
            </Link>
          )}
